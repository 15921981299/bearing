...
export const seoLandingPages: SeoLandingPage[] = [
  page('adjustable-combined-bearings','Bearing Designs','Adjustable Combined Bearings','Adjustable Combined Bearings','Eccentric and screw-adjustable combined bearings allow axial clearance to be set in steel-section guide systems.',[
    {heading:'Adjustment designs',body:'The axial roller may be positioned by an eccentric pin, external hex or screw mechanism. The adjustment range and access direction must match the assembly.',bullets:['4.454–4.463 eccentric series','KRES external-adjustment references','Jumbo 4.090–4.093 designs']},
  ...
  page('welded-plate-combined-bearings','Bearing Designs','Welded Plate Combined Bearings','Combined Bearings Welded on Plate','Plate-mounted combined bearings reduce fabrication steps and can be supplied for AP-series or drawing-based assemblies.',[
    {heading:'Plate configurations',body:'The bearing, weld location, plate thickness, holes and datum geometry form one controlled assembly.',bullets:['AP0, AP1, AP2 and AP3.1','Lubricated and Q variants','Custom laser-cut or machined plates']},
  ...
  page('jumbo-combined-bearings','Bearing Designs','Jumbo Combined Bearings','Jumbo Combined Bearings','Jumbo combined bearings support high radial and axial loads in cranes, steel plants and heavy lifting systems.',[
    {heading:'Heavy-duty references',body:'Common inquiry references include 4.085, 4.089 and the adjustable 4.090–4.093 series.',bullets:['Large radial roller diameters','Adjustable axial support','High-load steel-section guides']},
  ...
  ],[{label:'Industrial bearing RFQ checklist',href:'/resources/industrial-bearing-rfq-checklist/'},...productLinks]),
];
